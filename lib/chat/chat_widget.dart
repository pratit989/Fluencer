...
class _ChatWidgetState extends State<ChatWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<ConversationRefsRecord>>(
      stream: queryConversationRefsRecord(
        parent: currentUserReference,
        queryBuilder: (conversationRefsRecord) => conversationRefsRecord
            .where('user_ref', isEqualTo: widget.userDoc.reference),
        singleRecord: true,
      ),
      builder: (context, snapshot) {
        ...
        List<ConversationRefsRecord> chatConversationRefsRecordList =
            snapshot.data;
        // Return an empty Container when the document does not exist.
        if (snapshot.data.isEmpty) {
          return Container();
        }
        final chatConversationRefsRecord =
            chatConversationRefsRecordList.isNotEmpty
                ? chatConversationRefsRecordList.first
                : null;
        return Scaffold(
          key: scaffoldKey,
          appBar: AppBar(
                ...
                Expanded(
                  child: StreamBuilder<List<MessagesRecord>>(
                    stream: queryMessagesRecord(
                      parent: chatConversationRefsRecord.conversationRef,
